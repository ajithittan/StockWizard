...
const pages = ['Search','Sectors','Performance','Charting','SEC Data','Prediction','Analyzer','Correlate','Art']
const links = ['StockSearch','SectorSetUp','SectorPerformance','Charting','SecData','Prediction','Analyzer','Correlate','Art']
